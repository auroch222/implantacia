...
class Menu(models.Model):
    ...
    lan_menu = models.ForeignKey(Language, on_delete=models.CASCADE, null=True)
...
class SubMenu(models.Model):
    ...
    lan_submenu = models.ForeignKey(Language, on_delete=models.CASCADE, null=True)
    slug = models.SlugField(blank=True, null=True)
...
class Context(models.Model):
    ...
    context_lan = models.ForeignKey(Language, on_delete=models.CASCADE, null=True)
...
class ArticleContext(models.Model):
    article_lan = models.ForeignKey(Language, on_delete=models.CASCADE, null=True)
